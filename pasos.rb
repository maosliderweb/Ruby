...
# Programa: pasos.rb
Copyright = 
"Author: Mauricio Bohorquez Baños\n" +
"Email: maob7913@gmail.com\n" +
" País:Colombia" +
...
#-----------------------------------------------------------------------------------------------------------------------
# VERSIONS
# 0.8 Da un mensaje de error más fácil de entender, cuando el archivo de entrada no existe.
...
if $0 == __FILE__
  require 'io/console'
  p "Pulsa F9 para ejecutar tu programa paso a paso"
  ...
  begin
    ...
    if sourceFile == ""
      p "Tienes que especificar el nombre del programa a depurar:     ruby pasos.rb programa.rb"
    else
      p "No existe el programa:   #{sourceFile}"
    end
    programas = Dir.entries('.') - [".", "..", "pasos.rb"]
    p "Quizás quieres decir alguno de éstos: "
    puts programas
    exit
  end
  tp__tp.enable
